...
val connect_to_iris : Entities.Config.t -> Entities.Config.t Lwt.t
...
val get_strategy_positions : headers:Cohttp.Header.t -> gscid: string -> Yojson.Basic.t list Lwt.t
